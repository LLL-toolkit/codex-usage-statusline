...
> Apple Silicon macOS 지원은 v0.3.0 릴리스 후보 검증 단계이며 아직 일반 설치 대상이 아닙니다. 실기기 설치·제거 검증이 끝나기 전에는 아래 macOS 명령을 개발 검증에만 사용합니다.
...
Apple Silicon macOS v0.3.0 릴리스 후보 개발 검증용:
...
- Codex CLI **0.144.1**
- Windows x64 지원; Apple Silicon macOS는 v0.3.0 릴리스 후보 검증 중
- Intel Mac은 지원하지 않음

| 플랫폼 | 릴리스 빌드 | 실제 환경 검증 |
|---|---:|---:|
| Windows x64 | 자동화됨 | 지원 |
| Apple Silicon macOS | 자동화됨 | v0.3.0 릴리스 후보 검증 중 |
